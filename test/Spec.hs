...
record1Test = testCase "Testing record1" (do contents <- readFile "programs/record1.tig"
...
array2Test :: TestTree
array2Test = testCase "Testing array2" (do contents <- readFile "programs/array2.tig"
...
recursive_factorialTest = testCase "Testing recursive_factorial" (do contents <- readFile "programs/recursive_factorial.tig"
